    ...
    function loadNewsList(page) {
        ...
        fetch(`${baseUrl}?page=${page}`)
            ...
            .then(data => {
                ...
                widget.innerHTML = '<h1 class="news-title" style="font-size: 24pt; margin-bottom: 24px; font-family: \'Roboto Condensed\'; color: #840d0d">News Distribution by Trade PR</h1><div id="news-content"></div>';
